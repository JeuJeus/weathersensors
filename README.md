...
|_
NODEMCU_SEND_INTERVAL_ | optional | Time in Milliseconds defining how often the NodeMCU sends it's measurements to the backend (default: 5 minutes ``60 * 5 * 1000``|
|_
