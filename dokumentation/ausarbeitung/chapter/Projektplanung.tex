...
Trello ist die führende Online-Plattform für Kanban.%TODO was dieses kanban
...
\begin{itemize}
    ...
    \item \textbf{Backlog}: Dieser Bereich beinhaltet alle Karten, die zur Bearbeitung anstehen. Karten in diesem Bereich werden in der Regel bei einem Meeting einem oder mehreren Gruppenmitgliedern zugewiesen.%TODO und entstammen dem Feld nicht im Backlog -> priorisierung, für aktuellen "Sprint" relevante Karten
    \item \textbf{In Arbeit}: In diesen Bereich werden Karten geschoben, die aktuell bearbeitet werden.%TODO limit auf 2 Karten p.p.
    \item \textbf{In Prüfung}: Nach der Fertigstellung einer Karte werden die entwickelten Features vom gesamten Team im nächsten Meeting überprüft. Dadurch stellen wir eine hohe Code-Qualität sicher und können bei Bedarf Karten für Bugfixes oder Refactoring in das Backlog schieben. Arbeitspakete bleiben hier bis zur Fertigstellung aller verwandten Bugfixes.%TODO satzende
...
Durch diese Struktur ergeben sich fast automatisch auch an agile Entwicklung angelehnte Sprints.%TODO -> fast automatisch ~> explizit gewählt? kommt besser oder?
...
Die Sprints waren dadurch in der Regel nur wenige Tage lang. \\%TODO wie wäre es mit einer Woche was eine legitime Sprintlänge ist?
Für das Projekt wurde zunächst ein Prototyp nach dem Rapid-Prototyping-Prinzip entwickelt.%TODO Quelle?
Hierfür wurden die essentiellen Funktionen bereits in der ersten Woche umgesetzt, und damit eine rudimentäre Basis geschaffen, die in den folgenden Sprints um die zusätzlichen Features erweitert wurde.%TODO evt. eingehen auf vertikal durchexerziert funktional
...
Danach wurden nur noch später entdeckte Fehler behoben und die Dokumentation begonnen.%TODO Später entdeckte Fehler = schlecht, "letzer Schliff/Detailanpassungen = gut"?Alle im Projekt gesetzten Deadlines konnten erreicht oder sogar unterboten worden.
