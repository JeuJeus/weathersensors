...
\begin{table}[H]
	\begin{tabular}{|l|l|l|}
        ...
        \end{tabular} \\ \hline
    \end{tabular}
    \caption[Projektanforderungen]{Projektanforderungen (nach \cite{Wortmann.2020}, eigene Darstellung)}
\end{table}
...
\begin{figure}[H]
    \centering
    \begin{minipage}[t]{1\textwidth}
        \caption{Aktivitätendiagramm Backend}
        \includegraphics[width=1\textwidth]{img/backend_activity.png}\\
        \source{Eigene Darstellung}
        \label{fig:backend_activity}
    \end{minipage}
\end{figure}
...
\begin{center}
    ...
    \begin{longtable}{|p{0.45\textwidth}|p{0.35\textwidth}|p{0.1\textwidth}|}
        ...
        \hline
        Granularität überprüfen                                            & Die Granularity hat den Default Wert 100                                                             & \ding{51} \\
        \hline
        \hline
